...
open class Day2Part1 {
    ...
    protected open fun isReportSafe(report: Report): Boolean =
        areAllLevelsIncreasing(report.levels) || areAllLevelsDecreasing(report.levels)

    protected fun areAllLevelsIncreasing(levels: List<Int>): Boolean =
        levels.zipWithNext().all { (l1, l2) -> (l2 - l1) in 1..3 }

    protected fun areAllLevelsDecreasing(levels: List<Int>): Boolean =
